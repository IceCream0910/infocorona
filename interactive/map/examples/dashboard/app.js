...
am4core.ready(function() {
  ...
  sizeLabel.tooltip.setBounds({ x: 0, y: 0, width: 100000, height: 100000 })
  sizeLabel.tooltip.label.wrap = true;
  sizeLabel.tooltip.label.maxWidth = 300;
  sizeLabel.tooltipText = "어떤 나라들은 매우 많은 환자가 발생하여, 큰 차이가 있더라도 종종 더 적은 환자를 가진 나라들의 버블과 똑같이 보일 수 있습니다. 그럴 때는 이 슬라이더를 사용하여 버블의 최대 크기를 조정할 수 있습니다."
  sizeLabel.fill = am4core.color("#ffffff");
  ...
  filterSlider.height = am4core.percent(10);
  ...
  filterLabel.tooltipText = "환자 수가 적은 국가를 비교할 수 있도록 지도에서 환자가 많은 국가를 제거할 수 있습니다."
  filterLabel.fill = am4core.color("#ffffff");
  ...
  lineChart.fontSize = "0.6em";
  lineChart.paddingRight = 20;
  lineChart.paddingLeft = 20;
  lineChart.maskBullets = false;
  lineChart.zoomOutButton.disabled = true;
  lineChart.paddingBottom = 2;
  lineChart.paddingTop = 1;
  ...
  dateAxis.tooltip.label.fontSize = "0.7em";
  ...
  seriesTypeSwitch.leftLabel.text = "누적";
  seriesTypeSwitch.rightLabel.text = "일별"
  ...
  function addSeries(name, color) {
    ...
    series.tooltipText = "총 {name}: {valueY}";
  ...
  function updateCountryName() {
    countryName.text = currentCountry + ", " + mapChart.dateFormatter.format(currentDate, "yyyy.MM.dd");
  }
