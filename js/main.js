...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['9.25', '9.26', '9.27', '9.28', '9.29', '9.30', '10.1', '10.2', '10.3', '10.4'],
          datasets: [
            {
              label: "신규 확진자",
              data: [61, 95, 50, 38, 113, 77, 63, 75, 64, 73],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [588, 1321, 4785, 2949, 3222, 4464, 3836, 1938, 988],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          labels: ['9.29', '9.30', '10.1', '10.2', '10.3', '10.4'],
          datasets: [
            {
              label: "확진",
              data: [113, 77, 63, 75, 64, 73],
  ...
  try {
    ...
    var data3 = [11741, 9955, 5436, 5342, 6082, 6486] //검사
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ["9.28", "9.29", "9.30", "10.1", "10.2", "10.3"],
          datasets: [
            {
              label: "일 검사자수",
              data: data3,
  ...
  try {
    ...
    var data3 = [0.32, 1.14, 1.42, 1.18, 1.23, 0.99] //  (확진수)/(검사수)*100
