...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['7.11', '7.12', '7.13', '7.14', '7.15', '7.16', '7.17', '7.18', '7.19', '7.20'],
          datasets: [
            {
              label: "신규 확진자",
              data: [44, 62, 33, 39, 61, 60, 39, 34, 26, 45],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [240, 765, 3551, 1696, 1824, 2444, 1791, 919, 586],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          labels: ['7.15', '7.16', '7.17', '7.18', '7.19', '7.20'],
          datasets: [
            {
              label: "확진",
              data: [61, 60, 39, 34, 26, 45],
  ...
  try {
    ...
    var data3 = [23404, 23110, 22923, 21953, 21302, 23864] //검사중
    var data4 = [13612, 13672, 13711, 13745, 13771, 13816] //누적 확진
