...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['8.20', '8.21', '8.22', '8.23', '8.24', '8.25', '8.26', '8.27', '8.28', '8.29'],
          datasets: [
            {
              label: "신규 확진자",
              data: [324, 332, 397, 266, 280, 320, 441, 371, 323, 299],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [422, 1122, 4233, 2437, 2627, 3535, 2840, 1417, 767],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          labels: ['8.24', '8.25', '8.26', '8.27', '8.28', '8.29'],
          datasets: [
            {
              label: "확진",
              data: [280, 320, 441, 371, 323, 299],
  ...
  try {
    ...
    var data3 = [13236, 21415, 23669, 20073, 18138, 21612] //검사
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ["8.23", "8.24", "8.25", "8.26", "8.27", "8.28"],
          datasets: [
            {
              label: "일 검사자수",
              data: data3,
