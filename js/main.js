...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['4.29', '4.30', '5.1', '5.2' , '5.3', '5.4', '5.5', '5.6', '5.7', '5.8'],
          datasets: [
            {
              label: "신규 확진자",
              data: [4, 9, 6, 13, 8, 3, 2, 4, 12, 18],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [141, 592, 2979, 1177, 1438, 1958, 1355, 710, 488],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          labels: ['5.3', '5.4', '5.5', '5.6', '5.7', '5.8'],
          datasets: [
            {
              label: "확진",
              data: [8, 3, 2, 4, 12, 18],
  ...
  try {
    ...
    var data3 = [8176, 8858, 8009, 8429, 8867, 9153] //검사중
    var data4 = [10801, 10804, 10806, 10810, 10822, 10840] //누적 확진
