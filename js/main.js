...
(function($) {
    ...
    try {
        ...
        var myChart = new Chart(ctx, {
            type: 'bar',
            data: {
                labels: ['1.30', '1.31', '2.1', '2.2', '2.3', '2.4', '2.5'],
                datasets: [{
                    label: '국내 발생',
                    backgroundColor: "#778beb",
                    data: [325, 285, 295, 433, 429, 351, 366],
                }, {
                    label: '해외 유입',
                    backgroundColor: "#a9a9a9",
                    data: [30, 20, 41, 34, 22, 19, 27],
                }],
            },
            options: {
                tooltips: {
    ...
    try {
        ...
        var data3 = [33651, 81852, 73843, 74144, 72452, 78581]
    ...
    try {
        ...
        var data3 = [0.91, 0.41, 0.63, 0.61, 0.51, 0.50] //  (확진수)/(검사수)*100
