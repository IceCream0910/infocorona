...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['11.12', '11.13', '11.14', '11.15', '11.16', '11.17', '11.18', '11.19', '11.20', '11.21'],
          datasets: [
            {
              label: "일일 확진자",
              data: [191, 205, 208, 222, 230, 313, 343, 363, 386, 330],
  ...
  try {
    ...
    var data3 = [10813, 18064, 18607, 19481, 19600, 23303] //검사
  ...
  try {
    ...
    var data3 = [2.06, 1.27, 1.68, 1.76, 1.85, 1.63] //  (확진수)/(검사수)*100
