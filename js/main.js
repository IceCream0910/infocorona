...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['4.13', '4.14', '4.15', '4.16', '4.17', '4.18', '4.19', '4.20', '4.21', '4.22'],
          datasets: [
            {
              label: "신규 확진자",
              data: [27, 27, 22, 22, 18, 8, 13, 9, 11, 8],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [138, 584, 2933, 1141, 1418, 1952, 1344, 708, 484],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          labels: ['4.17', '4.18', '4.19', '4.20', '4.21', '4.22'],
          datasets: [
            {
              label: "확진",
              data: [18, 8, 13, 9, 11, 8],
  ...
  try {
    ...
    var data3 = [13550, 12243, 11981, 12721, 12121, 10139] //검사중
    var data4 = [10653, 10661, 10674, 10683, 10694, 10702] //누적 확진
