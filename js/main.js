...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['10.25', '10.26', '10.27', '10.28', '10.29', '10.30', '10.31', '11.1', '11.2', '11.3'],
          datasets: [
            {
              label: "신규 확진자",
              data: [119, 88, 103, 125, 114, 127, 124, 97, 75, 118],
  ...
  try {
    ...
    var data3 = [15018, 14253, 12261, 6138, 6020, 13209] //검사
  ...
  try {
    ...
    var data3 = [0.83, 0.80, 1.04, 2.02, 1.61, 0.57] //  (확진수)/(검사수)*100
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ["10.28", "10.29", "10.30", "10.31", "11.1", "11.1"],
          datasets: [
            {
              label: "검사 대비 확진율",
              data: data3,
