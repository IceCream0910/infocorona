...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['8.30', '8.31', '9.1', '9.2', '9.3', '9.4', '9.5', '9.6', '9.7', '9.8'],
          datasets: [
            {
              label: "신규 확진자",
              data: [248, 235, 267, 195, 198, 168, 167, 119, 136, 156],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [501, 1210, 4485, 2653, 2874, 3936, 3264, 1646, 863],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          labels: ['9.3', '9.4', '9.5', '9.6', '9.7', '9.8'],
          datasets: [
            {
              label: "확진",
              data: [198, 168, 167, 119, 136, 156],
  ...
  try {
    ...
    var data3 = [20257, 18354, 18139, 8890, 5362, 14781] //검사
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ["9.2", "9.3", "9.4", "9.5", "9.6", "9.7"],
          datasets: [
            {
              label: "일 검사자수",
              data: data3,
