...
(function($) {
        ...
        var myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [1029, 1072, 892, 824, 1060, 955, 1216],
                }, {
                    label: '해외 유입',
                    backgroundColor: "#a9a9a9",
                    data: [24, 25, 34, 45, 32, 30, 25],
                }],
            },
            options: {
                tooltips: {
    ...
    try {
        ...
        if (ctx) {
            ...
            var myChart = new Chart(ctx, {
                ...
                data: {
                    labels: ['12.19', '12.20', '12.21', '12.22', '12.23', '12.24'],
                    datasets: [{
                            label: "확진",
                            data: [1097, 926, 869, 1092, 985, 1241],
                            borderWidth: "0",
    ...
    try {
        ...
        var data3 = [36847, 30767, 58571, 54141, 113731, 118078] //검사
    ...
    try {
        ...
        var data3 = [2.98, 3.00, 1.48, 2.01, 0.87, 1.05] //  (확진수)/(검사수)*100
