...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['11.7', '11.8', '11.9', '11.10', '11.11', '11.12', '11.13', '11.14', '11.15', '11.16'],
          datasets: [
            {
              label: "일일 확진자",
              data: [143, 126, 100, 146, 143, 191, 205, 208, 223, 230],
  ...
  try {
    ...
    var data3 = [12574, 13238, 11639, 15878, 9589, 10813] //검사
  ...
  try {
    ...
    var data3 = [1.16, 1.08, 1.64, 1.29, 2.17, 2.06] //  (확진수)/(검사수)*100
