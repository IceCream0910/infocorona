...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['4.17', '4.18', '4.19', '4.20', '4.21', '4.22', '4.23', '4.24', '4.25', '4.26'],
          datasets: [
            {
              label: "신규 확진자",
              data: [18, 8, 13, 9, 11, 8, 6, 10, 10, 10],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [140, 588, 2943, 1152, 1422, 1953, 1347, 708, 485],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          labels: ['4.21', '4.22', '4.23', '4.24', '4.25', '4.26'],
          datasets: [
            {
              label: "확진",
              data: [11, 8, 6, 10, 10, 10],
  ...
  try {
    ...
    var data3 = [12121, 10139, 9600, 9259, 8999, 8895] //검사중
    var data4 = [10694, 10702, 10708, 10718, 10728,10738] //누적 확진
