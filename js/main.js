...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['10.20', '10.21', '10.22', '10.23', '10.24', '10.25', '10.26', '10.27', '10.28', '10.29'],
          datasets: [
            {
              label: "신규 확진자",
              data: [91, 121, 155, 77, 61, 119, 88, 103, 125, 114],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          labels: ['10.24', '10.25', '10.26', '10.27', '10.28', '10.29'],
          datasets: [
            {
              label: "확진",
              data: [61, 119, 88, 103, 125, 114],
  ...
  try {
    ...
    var data3 = [12058, 5467, 6118, 15323, 15373, 15018] //검사
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ["10.23", "10.24", "10.25", "10.26", "10.27", "10.28"],
          datasets: [
            {
              label: "일 검사자수",
              data: data3,
  ...
  try {
    ...
    var data3 = [0.64, 1.12, 0.95, 0.57, 0.67, 0.83] //  (확진수)/(검사수)*100
