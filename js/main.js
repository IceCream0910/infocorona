...
(function($) {
        ...
        var myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [429, 590, 590, 533, 414, 391, 313],
                }, {
                    label: '해외 유입',
                    backgroundColor: "#a9a9a9",
                    data: [28, 31, 31, 28, 32, 25, 19],
                }],
            },
            options: {
                tooltips: {
    ...
    try {
        ...
        if (ctx) {
            ...
            var myChart = new Chart(ctx, {
                ...
                data: {
                    labels: ['2.16', '2.17', '2.18', '2.19', '2.20', '2.21'],
                    datasets: [{
                            label: "확진",
                            data: [621, 621, 561, 446, 416, 332],
                            borderWidth: "0",
    ...
    try {
        ...
        var data3 = [76651, 71122, 75496, 81975, 42689, 32191]
    ...
    try {
        ...
        var data3 = [0.81, 0.87, 0.74, 0.54, 0.97, 1.03] //  (확진수)/(검사수)*100
