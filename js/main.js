...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['3.29', '3.30', '3.31', '4.1', '4.2', '4.3', '4.4', '4.5', '4.6', '4.7'],
          datasets: [
            {
              label: "신규 확진자",
              data: [78, 125, 101, 89, 86, 94, 81, 47, 47, 53],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [126, 548, 2832, 1102, 1387, 1915, 1312, 692, 470],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          labels: ['4.2', '4.3', '4.4', '4.5', '4.6', '4.7'],
          datasets: [
            {
              label: "확진",
              data: [86, 94, 81, 47, 47, 53],
  ...
  try {
    ...
    var data3 = [18908, 20144, 19571, 19295, 20650, 17858] //검사중
    var data4 = [10062, 10156, 10237, 10284, 10331, 10384] //누적 확진
