...
(function ($) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [551, 1274, 4684, 2822, 3083, 4280, 3644, 1833, 935],
  ...
  try {
    ...
    var data3 = [13060, 14473, 12797, 7539, 4888, 13523] //검사
  ...
  try {
    ...
    var data3 = [1.17, 0.87, 0.86, 1.09, 1.43, 0.45] //  (확진수)/(검사수)*100
