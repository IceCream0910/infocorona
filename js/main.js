...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['10.3', '10.4', '10.5', '10.6', '10.7', '10.8', '10.9', '10.10', '10.11', '10.12'],
          datasets: [
            {
              label: "신규 확진자",
              data: [75, 64, 73, 75, 114, 69, 54, 72, 58, 97, 102],
  ...
  try {
    ...
    var data3 = [10771, 11389, 4451, 5799, 5127, 13161] //검사
  ...
  try {
    ...
    var data3 = [0.64, 0.47, 1.61, 1.00, 1.89, 0.78] //  (확진수)/(검사수)*100
