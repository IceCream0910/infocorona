...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['10.23', '10.24', '10.25', '10.26', '10.27', '10.28', '10.29', '10.30', '10.31', '11.1'],
          datasets: [
            {
              label: "신규 확진자",
              data: [77, 61, 119, 88, 103, 125, 114, 127, 124, 97],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          labels: ['10.27', '10.28', '10.29', '10.30', '10.31', '11.1'],
          datasets: [
            {
              label: "확진",
              data: [103, 125, 114, 127, 124, 97],
  ...
  try {
    ...
    var data3 = [15323, 15373, 15018, 14253, 12261, 6138] //검사
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ["10.26", "10.27", "10.28", "10.29", "10.30", "10.31"],
          datasets: [
            {
              label: "일 검사자수",
              data: data3,
  ...
  try {
    ...
    var data3 = [0.57, 0.67, 0.83, 0.80, 1.04, 2.02] //  (확진수)/(검사수)*100
