...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['4.6', '4.7', '4.8', '4.9', '4.10', '4.11', '4.12', '4.13', '4.14', '4.15'],
          datasets: [
            {
              label: "신규 확진자",
              data: [47, 53, 39, 27, 30, 32, 25, 27, 27, 22],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [135, 572, 2900, 1132, 1410, 1940, 1341, 703, 480],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          labels: ['4.10', '4.11', '4.12', '4.13', '4.14', '4.15'],
          datasets: [
            {
              label: "확진",
              data: [30, 32, 25, 27, 27, 22],
  ...
  try {
    ...
    var data3 = [14070, 13788, 13391, 14651, 15026, 14266] //검사중
    var data4 = [10480, 10512, 10537, 10564, 10591, 10613] //누적 확진
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'line',
        data: {
          labels: ['4.9', '4.10', '4.11', '4.12', '4.13', '4.14'],
          datasets: [
            {
              label: '검사 중',    
