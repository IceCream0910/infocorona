...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['3.23', '3.24', '3.25', '3.26', '3.27', '3.28', '3.29', '3.30', '3.31', '4.1'],
          datasets: [
            {
              label: "신규 확진자",
              data: [76, 100, 104, 91, 146, 105, 78, 125, 101, 89],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [119, 522, 2704, 1043, 1336, 1878, 1258, 663, 453],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          labels: ['3.27', '3.28', '3.29', '3.30', '3.31', '4.1'],
          datasets: [
            {
              label: "확진",
              data: [146, 105, 78, 125, 101, 89],
  ...
  try {
    ...
    var data3 = [16564, 15028, 13531, 16892, 16585, 17885] //일일 검사
    var data4 = [9478, 9583, 9661, 9786, 9887, 9976] //누적 확진
