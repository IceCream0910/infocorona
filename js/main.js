...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['7.16', '7.17', '7.18', '7.19', '7.20', '7.21', '7.22', '7.23', '7.24', '7.25'],
          datasets: [
            {
              label: "신규 확진자",
              data: [60, 39, 34, 26, 45, 63, 59, 41, 113, 58],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [242, 778, 3598, 1763, 1897, 2505, 1835, 936, 596],
  ...
  try {
    ...
    var data3 = [4894, 12197, 9681, 8783, 9437, 8307] //검사
