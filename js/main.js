...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['9.19', '9.20', '9.21', '9.22', '9.23', '9.24', '9.25', '9.26', '9.27', '9.28'],
          datasets: [
            {
              label: "신규 확진자",
              data: [82, 70, 61, 110, 125, 114, 61, 95, 50, 38],
  ...
  try {
    ...
    var data3 = [12100, 11277, 10069, 6172, 4786, 11741] //검사
  ...
  try {
    ...
    var data3 = [1.03, 1.01, 0.55, 1.54, 1.04, 0.32] //  (확진수)/(검사수)*100
