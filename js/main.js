...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['12.02', '12.03', '12.04', '12.05', '12.06', '12.07', '12.08', '12.09', '12.10', '12.11'],
          datasets: [
            {
              label: "일일 확진자",
              data: [540, 629, 583, 631, 615, 594, 686, 682, 689, 950],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          labels: ['12.06', '12.07', '12.08', '12.09', '12.10', '12.11'],
          datasets: [
            {
              label: "확진",
              data: [615, 594, 686, 682, 689, 950],
              borderWidth: "0",
  ...
  try {
    ...
    var data3 = [14215, 8686, 28113, 27043, 28341, 29597] //검사
  ...
  try {
    ...
    var data3 = [4.33, 6.84, 2.44, 2.52, 2.43, 3.21] //  (확진수)/(검사수)*100
