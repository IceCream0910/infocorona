...
(function($) {
        ...
        var myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [596, 631, 419, 508, 536, 496, 484],
                }, {
                    label: '해외 유입',
                    backgroundColor: "#a9a9a9",
                    data: [45, 34, 32, 29, 26, 28, 29],
                }],
            },
            options: {
                tooltips: {
    ...
    try {
        ...
        if (ctx) {
            ...
            var myChart = new Chart(ctx, {
                ...
                data: {
                    labels: ['1.9', '1.10', '1.11', '1.12', '1.13', '1.14'],
                    datasets: [{
                            label: "확진",
                            data: [665, 451, 537, 562, 524, 513],
                            borderWidth: "0",
                        ...
                        {
                            label: "완치",
                            data: [1085, 2143, 1017, 1067, 1136, 764],
                            borderWidth: "0",
    ...
    try {
        ...
        var data3 = [56298, 42043, 94537, 91583, 87625, 84390]
    ...
    try {
        ...
        var data3 = [1.18, 1.07, 0.57, 0.61, 0.60, 0.61] //  (확진수)/(검사수)*100
