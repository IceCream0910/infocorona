...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['9.8', '9.9', '9.10', '9.11', '9.12', '9.13', '9.14', '9.15', '9.16', '9.17'],
          datasets: [
            {
              label: "신규 확진자",
              data: [156, 155, 176, 136, 121, 109, 106, 113, 153, 126],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [544, 1255, 4631, 2768, 3023, 4180, 3558, 1780, 918],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          labels: ['9.12', '9.13', '9.14', '9.15', '9.16', '9.17'],
          datasets: [
            {
              label: "확진",
              data: [121, 109, 106, 113, 153, 126],
  ...
  try {
    ...
    var data3 = [16246, 7813, 7732, 13576, 14254, 13060] //검사
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ["9.11", "9.12", "9.13", "9.14", "9.15", "9.16"],
          datasets: [
            {
              label: "일 검사자수",
              data: data3,
  ...
  try {
    ...
    var data3 = [0.84, 1.54, 1.41, 0.78, 0.79, 1.17] //  (확진수)/(검사수)*100
