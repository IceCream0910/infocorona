...
(function($) {
        ...
        var myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [338, 516, 479, 445, 423, 325, 285],
                }, {
                    label: '해외 유입',
                    backgroundColor: "#a9a9a9",
                    data: [16, 43, 18, 24, 35, 30, 20],
                }],
            },
            options: {
                tooltips: {
    ...
    try {
        ...
        if (ctx) {
            ...
            var myChart = new Chart(ctx, {
                ...
                data: {
                    labels: ['1.26', '1.27', '1.28', '1.29', '1.30', '1.31'],
                    datasets: [{
                            label: "확진",
                            data: [559, 497, 469, 458, 355, 305],
                            borderWidth: "0",
    ...
    try {
        ...
        var data3 = [68504, 77650, 68421, 77167, 48800, 33651]
    ...
    try {
        ...
        var data3 = [0.82, 0.64, 0.69, 0.59, 0.73, 0.91] //  (확진수)/(검사수)*100
