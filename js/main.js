...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['10.30', '10.31', '11.1', '11.2', '11.3', '11.4', '11.5', '11.6', '11.7', '11.8'],
          datasets: [
            {
              label: "신규 확진자",
              data: [127, 124, 97, 75, 118, 125, 145, 89, 143, 126],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          labels: ['11.3', '11.4', '11.5', '11.6', '11.7', '11.8'],
          datasets: [
            {
              label: "확진",
              data: [118, 125, 145, 89, 143, 126],
  ...
  try {
    ...
    var data3 = [13209, 12401, 11446, 12608, 10935, 5631] //검사
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ["11.2", "11.3", "11.4", "11.5", "11.6", "11.7"],
          datasets: [
            {
              label: "일 검사자수",
              data: data3,
  ...
  try {
    ...
    var data3 = [0.57, 0.95, 1.09, 1.20, 0.81, 2.54] //  (확진수)/(검사수)*100
