...
(function ($) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [140, 591, 2964, 1166, 1436, 1957, 1354, 710, 488],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          labels: ['4.30', '5.1', '5.2', '5.3', '5.4', '5.5'],
          datasets: [
            {
              label: "확진",
              data: [9, 6, 13, 8, 3, 2],
  ...
  try {
    ...
    var data3 = [8685, 8496, 8588, 8176, 8858, 8009] //검사중
    var data4 = [10774, 10780, 10793, 10801, 10804, 10806] //누적 확진
