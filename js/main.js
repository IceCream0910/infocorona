...
(function ($) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [588, 1317, 4781, 2940, 3209, 4456, 3824, 1930, 982],
  ...
  try {
    ...
    var data3 = [4786, 11741, 9955, 5436, 5342, 6082] //검사
  ...
  try {
    ...
    var data3 = [1.04, 0.32, 1.14, 1.42, 1.18, 1.23] //  (확진수)/(검사수)*100
