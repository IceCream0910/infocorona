...
var myChart = new Chart(ctx, {
  type: 'bar',
  data: {
    labels: ['12.09', '12.10', '12.11', '12.12', '12.13', '12.14', '12.15'],
    datasets: [{
      label: '국내 발생',
      backgroundColor: "#778beb",
      data: [646, 673, 928, 1002, 682, 848, 1054],
    }, {
      label: '해외 유입',
      backgroundColor: "#a9a9a9",
      data: [36, 16, 22, 28, 36, 32, 24],
    }],
  },
options: {
    tooltips: {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진",
              data: [689, 950, 1030, 718, 880, 1078],
              borderWidth: "0",
  ...
  try {
    ...
    var data3 = [24727, 38651, 24731, 22444, 44181, 47549] //검사
  ...
  try {
    ...
    var data3 = [2.78, 2.45, 4.16, 3.19, 1.99, 2.27] //  (확진수)/(검사수)*100
