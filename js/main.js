...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['7.7', '7.8', '7.9', '7.10', '7.11', '7.12', '7.13', '7.14', '7.15', '7.16'],
          datasets: [
            {
              label: "신규 확진자",
              data: [63, 50, 45, 35, 44, 62, 33, 39, 61, 60],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [231, 756, 3517, 1659, 1805, 2424, 1781, 908, 580],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          labels: ['7.11', '7.12', '7.13', '7.14', '7.15', '7.16'],
          datasets: [
            {
              label: "확진",
              data: [44, 62, 33, 39, 61, 60],
  ...
  try {
    ...
    var data3 = [21830, 21845, 24289, 23297, 23404, 23110] //검사중
    var data4 = [13417, 13479, 13512, 13551, 13612, 13672] //누적 확진
