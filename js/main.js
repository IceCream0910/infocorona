...
(function ($) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "신규 확진자",
              data: [75, 64, 73, 75, 114, 69, 54, 72, 58, 97],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          labels: ['10.6', '10.7', '10.8', '10.9', '10.10', '10.11'],
          datasets: [
            {
              label: "확진",
              data: [114, 69, 54, 72, 58, 97],
  ...
  try {
    ...
    var data3 = [12640, 10771, 11389, 4451, 5799, 5127] //검사
  ...
  try {
    ...
    var data3 = [0.90, 0.64, 0.47, 1.61, 1.00, 1.89] //  (확진수)/(검사수)*100
