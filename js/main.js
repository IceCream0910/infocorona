...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['6.7', '6.8', '6.9', '6.10', '6.11', '6.12', '6.13', '6.14', '6.15', '6.16'],
          datasets: [
            {
              label: "신규 확진자",
              data: [38, 38, 50, 45, 56, 49, 34, 37, 34, 43],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [174, 683, 3267, 1380, 1601, 2189, 1561, 810, 534],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          labels: ['6.11', '6.12', '6.13', '6.14', '6.15', '6.16'],
          datasets: [
            {
              label: "확진",
              data: [56, 49, 34, 37, 34, 43],
  ...
  try {
    ...
    var data3 = [24244, 23352, 21356, 20793, 22632, 21489] //검사중
    var data4 = [12003, 12051, 12085, 12121, 12155, 12198] //누적 확진
