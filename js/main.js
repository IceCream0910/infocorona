...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['11.11', '11.12', '11.13', '11.14', '11.15', '11.16', '11.17', '11.18', '11.19', '11.20'],
          datasets: [
            {
              label: "일일 확진자",
              data: [143, 191, 205, 208, 222, 230, 313, 343, 363, 386],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          labels: ['11.15', '11.16', '11.17', '11.18', '11.19', '11.20'],
          datasets: [
            {
              label: "확진",
              data: [222, 230, 313, 343, 363, 386],
  ...
  try {
    ...
    var data3 = [9589, 10813, 18064, 18607, 19481, 19600] //검사
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ["11.14", "11.15", "11.16", "11.17", "11.18", "11.19"],
          datasets: [
            {
              label: "일 검사자수",
              data: data3,
  ...
  try {
    ...
    var data3 = [2.17, 2.06, 1.27, 1.68, 1.76, 1.85] //  (확진수)/(검사수)*100
