...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['6.26', '6.27', '6.28', '6.29', '6.30', '7.1', '7.2', '7.3', '7.4', '7.5'],
          datasets: [
            {
              label: "신규 확진자",
              data: [51, 62, 42, 43, 51, 54, 63, 63, 61, 48],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [206, 728, 3411, 1560, 1716, 2347, 1724, 878, 567],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          labels: ['6.30', '7.1', '7.2', '7.3', '7.4', '7.5'],
          datasets: [
            {
              label: "확진",
              data: [51, 54, 63, 63, 61, 48],
  ...
  try {
    ...
    var data3 = [19526, 19782, 21560, 22321, 21649, 21292] //검사중
    var data4 = [12850, 12904, 12967, 13030, 13091, 13137] //누적 확진
