...
(function($) {
        ...
        var myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [682, 848, 1054, 993, 1036, 1029, 1072],
                }, {
                    label: '해외 유입',
                    backgroundColor: "#a9a9a9",
                    data: [36, 32, 24, 21, 26, 24, 25],
                }],
            },
            options: {
                tooltips: {
        ...
        if (ctx) {
            ...
            var myChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                            label: "확진",
                            data: [880, 1078, 1014, 1062, 1052, 1097],
                            borderWidth: "0",
    ...
    try {
        ...
        var data3 = [22444, 44181, 47549, 50071, 50955, 56450] //검사
        ...
        if (ctx) {
            ...
            var myChart = new Chart(ctx, {
                type: 'bar',
                data: {
                    labels: ["12.13", "12.14", "12.15", "12.16", "12.17", "12.18"],
                    datasets: [{
                        label: "일 검사자수",
                        data: data3,
                        borderColor: "#556ee6",
    ...
    try {
        ...
        var data3 = [3.19, 1.99, 2.27, 2.03, 2.08, 1.86] //  (확진수)/(검사수)*100
