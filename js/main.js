...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['10.16', '10.17', '10.18', '10.19', '10.20', '10.21', '10.22', '10.23', '10.24', '10.25'],
          datasets: [
            {
              label: "신규 확진자",
              data: [73, 91, 76, 58, 91, 121, 155, 77, 61, 119],
  ...
  try {
    ...
    var data3 = [12085, 12180, 11836, 13296, 12058, 5467] //검사
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ["10.19", "10.20", "10.21", "10.22", "10.23", "10.24"],
          datasets: [
            {
              label: "일 검사자수",
              data: data3,
  ...
  try {
    ...
    var data3 = [0.48, 0.75, 1.02, 1.17, 0.64, 1.12] //  (확진수)/(검사수)*100
