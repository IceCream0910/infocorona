...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['3.22', '3.23', '3.24', '3.25', '3.26', '3.27', '3.28', '3.29', '3.30', '3.31'],
          datasets: [
            {
              label: "신규 확진자",
              data: [64, 76, 100, 104, 91, 146, 105, 78, 125, 101],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [116, 519, 2682, 1027, 1323, 1865, 1245, 658, 452],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          labels: ['3.26', '3.27', '3.28', '3.29', '3.30', '3.31'],
          datasets: [
            {
              label: "확진",
              data: [91, 146, 105, 78, 125, 101],
  ...
  try {
    ...
    var data3 = [14369, 16564, 15028, 13531, 16892, 16585] //일일 검사
    var data4 = [9332, 9478, 9583, 9661, 9786, 9887] //누적 확진
