...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['10.4', '10.5', '10.6', '10.7', '10.8', '10.9', '10.10', '10.11', '10.12', '10.13'],
          datasets: [
            {
              label: "신규 확진자",
              data: [73, 75, 114, 69, 54, 72, 58, 97, 102, 84],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [623, 1369, 4942, 3060, 3318, 4583, 3970, 2008, 1016],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          labels: ['10.8', '10.9', '10.10', '10.11', '10.12', '10.13'],
          datasets: [
            {
              label: "확진",
              data: [54, 72, 58, 97, 102, 84],
  ...
  try {
    ...
    var data3 = [11389, 4451, 5799, 5127, 13161, 12683] //검사
  ...
  try {
    ...
    var data3 = [0.47, 1.61, 1.00, 1.89, 0.78, 0.66] //  (확진수)/(검사수)*100
