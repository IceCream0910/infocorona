...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['4.22', '4.23', '4.24', '4.25', '4.26', '4.27', '4.28', '4.29', '4.30', '5.1'],
          datasets: [
            {
              label: "신규 확진자",
              data: [8, 6, 10, 10, 10, 14, 9, 4, 9, 6],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [140, 590, 2960, 1160, 1430, 1956, 1349, 709, 486],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          labels: ['4.26', '4.27', '4.28', '4.29', '4.30', '5.1'],
          datasets: [
            {
              label: "확진",
              data: [10, 14, 9, 4, 9, 6],
  ...
  try {
    ...
    var data3 = [8895, 9023, 8307, 8634, 8685, 8496] //검사중
    var data4 = [10738, 10752, 10761, 10765, 10774, 10780] //누적 확진
