...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['11.15', '11.16', '11.17', '11.18', '11.19', '11.20', '11.21', '11.22', '11.23', '11.24'],
          datasets: [
            {
              label: "일일 확진자",
              data: [222, 230, 313, 343, 363, 386, 330, 271, 349, 382],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          labels: ['11.19', '11.20', '11.21', '11.22', '11.23', '11.24'],
          datasets: [
            {
              label: "확진",
              data: [363, 386, 330, 271, 349, 382],
  ...
  try {
    ...
    var data3 = [19481, 19600, 23303, 12144, 13245, 24264] //검사
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ["11.18", "11.19", "11.20", "11.21", "11.22", "11.23"],
          datasets: [
            {
              label: "일 검사자수",
              data: data3,
  ...
  try {
    ...
    var data3 = [1.76, 1.85, 1.66, 2.72, 2.05, 1.44] //  (확진수)/(검사수)*100
