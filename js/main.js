...
(function ($) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "일일 확진자",
              data: [511, 540, 629, 583, 631, 615, 594, 686, 682, 689],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          labels: ['12.05', '12.06', '12.07', '12.08', '12.09', '12.10'],
          datasets: [
            {
              label: "확진",
              data: [631, 615, 594, 686, 682, 689],
              borderWidth: "0",
  ...
  try {
    ...
    var data3 = [12922, 14215, 8686, 28113, 27043, 28341] //검사
  ...
  try {
    ...
    var data3 = [4.88, 4.33, 6.84, 2.44, 2.52, 2.43] //  (확진수)/(검사수)*100
