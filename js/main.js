...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['10.7', '10.8', '10.9', '10.10', '10.11', '10.12', '10.13', '10.14', '10.15', '10.16'],
          datasets: [
            {
              label: "신규 확진자",
              data: [69, 54, 72, 58, 97, 102, 84, 110, 47, 73],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [628, 1374, 4962, 3079, 3336, 4596, 3990, 2021, 1049],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          labels: ['10.11', '10.12', '10.13', '10.14', '10.15', '10.16'],
          datasets: [
            {
              label: "확진",
              data: [97, 102, 84, 110, 47, 73],
  ...
  try {
    ...
    var data3 = [5799, 5127, 13161, 12683, 9296, 8687] //검사
  ...
  try {
    ...
    var data3 = [1.00, 1.89, 0.78, 0.66, 1.18, 0.54] //  (확진수)/(검사수)*100
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ["10.9", "10.10", "10.11", "10.12", "10.13", "10.14"],
          datasets: [
            {
              label: "검사 대비 확진율",
              data: data3,
