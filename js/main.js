...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['6.5', '6.6', '6.7', '6.8', '6.9', '6.10', '6.11', '6.12', '6.13', '6.14'],
          datasets: [
            {
              label: "신규 확진자",
              data: [51, 57, 38, 38, 50, 45, 56, 49, 34, 37],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [170, 681, 3256, 1362, 1595, 2176, 1550, 799, 532],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          labels: ['6.9', '6.10', '6.11', '6.12', '6.13', '6.14'],
          datasets: [
            {
              label: "확진",
              data: [50, 45, 56, 49, 34, 37],
  ...
  try {
    ...
    var data3 = [26233, 25494, 24244, 23352, 21356, 20793] //검사중
    var data4 = [11902, 11947, 12003, 12051, 12085, 12121] //누적 확진
