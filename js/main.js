...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['7.18', '7.19', '7.20', '7.21', '7.22', '7.23', '7.24', '7.25', '7.26', '7.27'],
          datasets: [
            {
              label: "신규 확진자",
              data: [34, 26, 45, 63, 59, 41, 113, 58, 25, 28],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [245, 781, 3607, 1774, 1907, 2511, 1840, 941, 597],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          labels: ['7.22', '7.23', '7.24', '7.25', '7.26', '7.27'],
          datasets: [
            {
              label: "확진",
              data: [63, 59, 41, 113, 58, 25],
  ...
  try {
    ...
    var data3 = [9681, 8783, 9437, 8307, 4292, 4048] //검사
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ["7.21", "7.22", "7.23", "7.24", "7.25", "7.26"],
          datasets: [
            {
              label: "일 검사자수",
              data: data3,
