...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['8.25', '8.26', '8.27', '8.28', '8.29', '8.30', '8.31', '9.1', '9.2', '9.3'],
          datasets: [
            {
              label: "신규 확진자",
              data: [320, 441, 371, 323, 299, 248, 235, 267, 195, 198],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [473, 1181, 4410, 2561, 2770, 3768, 3098, 1556, 827],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          labels: ['8.29', '8.30', '8.31', '9.1', '9.2', '9.3'],
          datasets: [
            {
              label: "확진",
              data: [299, 248, 235, 267, 195, 198],
  ...
  try {
    ...
    var data3 = [21612, 14841, 13519, 21391, 21215, 20257] //검사
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ["8.28", "8.29", "8.30", "8.31", "9.1", "9.2"],
          datasets: [
            {
              label: "일 검사자수",
              data: data3,
