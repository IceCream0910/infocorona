...
(function($) {
        ...
        var myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [403, 369, 405, 338, 516, 479, 445],
                }, {
                    label: '해외 유입',
                    backgroundColor: "#a9a9a9",
                    data: [28, 23, 32, 16, 43, 18, 24],
                }],
            },
            options: {
                tooltips: {
    ...
    try {
        ...
        if (ctx) {
            ...
            var myChart = new Chart(ctx, {
                ...
                data: {
                    labels: ['1.23', '1.24', '1.25', '1.26', '1.27', '1.28'],
                    datasets: [{
                            label: "확진",
                            data: [392, 437, 354, 559, 497, 469],
                            borderWidth: "0",
    ...
    try {
        ...
        var data3 = [37627, 29362, 71046, 68504, 77650, 68421]
    ...
    try {
        ...
        var data3 = [1.04, 1.49, 0.50, 0.82, 0.64, 0.69] //  (확진수)/(검사수)*100
