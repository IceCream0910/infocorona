        ...
        var myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [1054, 993, 1036, 1029, 1072, 892, 824],
                }, {
                    label: '해외 유입',
                    backgroundColor: "#a9a9a9",
                    data: [24, 21, 26, 24, 25, 34, 45],
                }],
            },
            options: {
                tooltips: {
        ...
        if (ctx) {
            ...
            var myChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                            label: "확진",
                            data: [1014, 1062, 1052, 1097, 926, 869],
                            borderWidth: "0",
