...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['8.3', '8.4', '8.5', '8.6', '8.7', '8.8', '8.9', '8.10', '8.11', '8.12'],
          datasets: [
            {
              label: "신규 확진자",
              data: [34, 33, 43, 20, 43, 36, 28, 34, 54, 56],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [264, 816, 3696, 1885, 1995, 2608, 1933, 966, 607],
  ...
  try {
    ...
    var data3 = [7165, 6862, 4136, 3653, 9541, 8808] //검사
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ["8.6", "8.7", "8.8", "8.9", "8.10", "8.11"],
          datasets: [
            {
              label: "일 검사자수",
              data: data3,
