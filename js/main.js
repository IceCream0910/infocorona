...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['9.21', '9.22', '9.23', '9.24', '9.25', '9.26', '9.27', '9.28', '9.29', '9.30'],
          datasets: [
            {
              label: "신규 확진자",
              data: [61, 110, 125, 114, 61, 95, 50, 38, 113, 77],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [578, 1306, 4762, 2908, 3178, 4421, 3782, 1906, 971],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          labels: ['9.25', '9.26', '9.27', '9.28', '9.29', '9.30'],
          datasets: [
            {
              label: "확진",
              data: [61, 95, 50, 38, 113, 77],
  ...
  try {
    ...
    var data3 = [11277, 10069, 6172, 4786, 11741, 9955] //검사
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ["9.24", "9.25", "9.26", "9.27", "9.28", "9.29"],
          datasets: [
            {
              label: "일 검사자수",
              data: data3,
  ...
  try {
    ...
    var data3 = [1.01, 0.55, 1.54, 1.04, 0.32, 1.14] //  (확진수)/(검사수)*100
