...
(function ($) {
  ...
  try {
    ...
    var data3 = [13055, 12640, 10771, 11389, 4451, 5799] //검사
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ["10.4", "10.6", "10.7", "10.8", "10.9", "10.10"],
          datasets: [
            {
              label: "일 검사자수",
              data: data3,
  ...
  try {
    ...
    var data3 = [0.57, 0.90, 0.64, 0.47, 1.61, 1.00] //  (확진수)/(검사수)*100
