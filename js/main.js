...
(function($) {
        ...
        var myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [314, 403, 369, 405, 338, 516, 479],
                }, {
                    label: '해외 유입',
                    backgroundColor: "#a9a9a9",
                    data: [32, 28, 23, 32, 16, 43, 18],
                }],
            },
            options: {
                tooltips: {
    ...
    try {
        ...
        var data3 = [74184, 37627, 29362, 71046, 68504, 77650]
    ...
    try {
        ...
        var data3 = [0.58, 1.04, 1.49, 0.50, 0.82, 0.64] //  (확진수)/(검사수)*100
