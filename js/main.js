...
(function ($) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "신규 확진자",
              data: [8, 13, 9, 11, 8, 6, 10, 10, 10, 14],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [140, 590, 2948, 1154, 1423, 1955, 1348, 709, 485],
  ...
  try {
    ...
    var data3 = [10139, 9600, 9259, 8999, 8895, 9023] //검사중
    var data4 = [10702, 10708, 10718, 10728,10738, 10752] //누적 확진
