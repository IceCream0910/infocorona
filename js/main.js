...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['10.19', '10.20', '10.21', '10.22', '10.23', '10.24', '10.25', '10.26', '10.27', '10.28'],
          datasets: [
            {
              label: "신규 확진자",
              data: [58, 91, 121, 155, 77, 61, 119, 88, 103, 125],
  ...
  try {
    ...
    var data3 = [13296, 12058, 5467, 6118, 15323, 15373] //검사
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ["10.22", "10.23", "10.24", "10.25", "10.26", "10.27"],
          datasets: [
            {
              label: "일 검사자수",
              data: data3,
  ...
  try {
    ...
    var data3 = [1.17, 0.64, 1.12, 0.95, 0.57, 0.67] //  (확진수)/(검사수)*100
