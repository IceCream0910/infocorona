...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['5.19', '5.20', '5.21', '5.22', '5.23', '5.24', '5.25', '5.26', '5.27', '5.28'],
          datasets: [
            {
              label: "신규 확진자",
              data: [32, 12, 20, 23, 25, 16, 19, 40, 79, 58],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [156, 650, 3158, 1283, 1513, 2023, 1400, 724, 495],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          labels: ['5.23', '5.24', '5.25', '5.26', '5.27', '5.28'],
          datasets: [
            {
              label: "확진",
              data: [25, 16, 19, 40, 79, 58],
  ...
  try {
    ...
    var data3 = [20333, 19089, 22044, 21061, 22370, 24557] //검사중
    var data4 = [11190, 11206, 11225, 11265, 11344, 11402] //누적 확진
