  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['10.22', '10.23', '10.24', '10.25', '10.26', '10.27', '10.28', '10.29', '10.30', '10.31'],
          datasets: [
            {
              label: "신규 확진자",
              data: [155, 77, 61, 119, 88, 103, 125, 114, 127, 124],
