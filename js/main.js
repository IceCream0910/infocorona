...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['4.7', '4.8', '4.9', '4.10', '4.11', '4.12', '4.13', '4.14', '4.15', '4.16'],
          datasets: [
            {
              label: "신규 확진자",
              data: [53, 39, 27, 30, 32, 25, 27, 27, 22, 22],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [136, 576, 2909, 1135, 1411, 1942, 1342, 704, 480],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          labels: ['4.11', '4.12', '4.13', '4.14', '4.15', '4.16'],
          datasets: [
            {
              label: "확진",
              data: [32, 25, 27, 27, 22, 22],
  ...
  try {
    ...
    var data3 = [13788, 13391, 14651, 15026, 14266, 14186] //검사중
    var data4 = [10512, 10537, 10564, 10591, 10613, 10635] //누적 확진
