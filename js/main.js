...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['9.12', '9.13', '9.14', '9.15', '9.16', '9.17', '9.18', '9.19', '9.20', '9.21'],
          datasets: [
            {
              label: "신규 확진자",
              data: [121, 109, 106, 113, 153, 126, 110, 82, 70, 61],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [550, 1272, 4678, 2812, 3073, 4264, 3634, 1828, 934],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          labels: ['9.16', '9.17', '9.18', '9.19', '9.20', '9.21'],
          datasets: [
            {
              label: "확진",
              data: [153, 126, 110, 82, 70, 61],
  ...
  try {
    ...
    var data3 = [14254, 13060, 14473, 12797, 7539, 4888] //검사
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ["9.15", "9.16", "9.17", "9.18", "9.19", "9.20"],
          datasets: [
            {
              label: "일 검사자수",
              data: data3,
  ...
  try {
    ...
    var data3 = [0.79, 1.17, 0.87, 0.86, 1.09, 1.43] //  (확진수)/(검사수)*100
