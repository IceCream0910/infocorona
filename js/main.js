...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['9.10', '9.11', '9.12', '9.13', '9.14', '9.15', '9.16', '9.17', '9.18', '9.19'],
          datasets: [
            {
              label: "신규 확진자",
              data: [176, 136, 121, 109, 106, 113, 153, 126, 110, 82],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [548, 1264, 4653, 2792, 3053, 4239, 3608, 1807, 929],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          labels: ['9.14', '9.15', '9.16', '9.17', '9.18', '9.19'],
          datasets: [
            {
              label: "확진",
              data: [106, 113, 153, 126, 110, 82],
  ...
  try {
    ...
    var data3 = [7732, 13576, 14254, 13060, 14473, 12797] //검사
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ["9.13", "9.14", "9.15", "9.16", "9.17", "9.18"],
          datasets: [
            {
              label: "일 검사자수",
              data: data3,
  ...
  try {
    ...
    var data3 = [1.41, 0.78, 0.79, 1.17, 0.87, 0.86] //  (확진수)/(검사수)*100
