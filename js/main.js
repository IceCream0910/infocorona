...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['11.22', '11.23', '11.24', '11.25', '11.26', '11.27', '11.28', '11.29', '11.30', '12.01'],
          datasets: [
            {
              label: "일일 확진자",
              data: [271, 349, 382, 583, 569, 504, 450, 438, 451, 511],
  ...
  try {
    ...
    var data3 = [2.64, 2.25, 3.01, 3.07, 1.98, 2.22] //  (확진수)/(검사수)*100
