...
(function($) {
        ...
        var myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [631, 419, 508, 536, 496, 484, 547],
                }, {
                    label: '해외 유입',
                    backgroundColor: "#a9a9a9",
                    data: [34, 32, 29, 26, 28, 29, 33],
                }],
            },
            options: {
                tooltips: {
            ...
            var myChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        {
                            label: "완치",
                            data: [2143, 1017, 1067, 1136, 764, 1018],
                            borderWidth: "0",
    ...
    try {
        ...
        var data3 = [42043, 94537, 91583, 87625, 84390, 87806]
    ...
    try {
        ...
        var data3 = [1.07, 0.57, 0.61, 0.60, 0.61, 0.66] //  (확진수)/(검사수)*100
