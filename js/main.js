...
(function($) {
    ...
    try {
        ...
        var myChart = new Chart(ctx, {
            type: 'bar',
            data: {
                labels: ['2.8', '2.9', '2.10', '2.11', '2.12', '2.13', '2.14'],
                datasets: [{
                    label: '국내 발생',
                    backgroundColor: "#778beb",
                    data: [273, 414, 467, 384, 345, 304, 323],
                }, {
                    label: '해외 유입',
                    backgroundColor: "#a9a9a9",
                    data: [30, 30, 37, 19, 17, 22, 21],
                }],
            },
            options: {
                tooltips: {
    ...
    try {
        ...
        var data3 = [77291, 81260, 41983, 36663, 50892, 43312]
    ...
    try {
        ...
        var data3 = [0.57, 0.62, 0.96, 0.99, 0.64, 0.79] //  (확진수)/(검사수)*100
