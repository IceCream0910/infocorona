...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['10.6', '10.7', '10.8', '10.9', '10.10', '10.11', '10.12', '10.13', '10.14', '10.15'],
          datasets: [
            {
              label: "신규 확진자",
              data: [114, 69, 54, 72, 58, 97, 102, 84, 110, 47],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [628, 1372, 4955, 3070, 3326, 4588, 3983, 2019, 1047],
  ...
  try {
    ...
    var data3 = [4451, 5799, 5127, 13161, 12683, 9296] //검사
  ...
  try {
    ...
    var data3 = [1.61, 1.00, 1.89, 0.78, 0.66, 1.18] //  (확진수)/(검사수)*100
