...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['10.27', '10.28', '10.29', '10.30', '10.31', '11.1', '11.2', '11.3', '11.4', '11.5'],
          datasets: [
            {
              label: "신규 확진자",
              data: [103, 125, 114, 127, 124, 97, 75, 118, 125, 145],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          labels: ['10.31', '11.1', '11.2', '11.3', '11.4', '11.5'],
          datasets: [
            {
              label: "확진",
              data: [124, 97, 75, 118, 125, 145],
  ...
  try {
    ...
    var data3 = [12261, 6138, 6020, 13209, 12401, 11446] //검사
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ["10.30", "10.31", "11.1", "11.2", "11.3", "11.4"],
          datasets: [
            {
              label: "일 검사자수",
              data: data3,
  ...
  try {
    ...
    var data3 = [1.04, 2.02, 1.61, 0.57, 0.95, 1.09] //  (확진수)/(검사수)*100
