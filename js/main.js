  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['7.29', '7.30', '7.31', '8.1', '8.2', '8.3', '8.4', '8.5', '8.6', '8.7'],
          datasets: [
            {
              label: "신규 확진자",
              data: [18, 36, 31, 30, 23, 34, 33, 43, 20, 43],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [257, 802, 3664, 1849, 1968, 2556, 1898, 957, 601],
