...
(function($) {
        ...
        var myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [547, 500, 366, 351, 373, 380, 314],
                }, {
                    label: '해외 유입',
                    backgroundColor: "#a9a9a9",
                    data: [33, 20, 23, 35, 31, 21, 32],
                }],
            },
            options: {
                tooltips: {
    ...
    try {
        ...
        if (ctx) {
            ...
            var myChart = new Chart(ctx, {
                ...
                data: {
                    labels: ['1.16', '1.17', '1.18', '1.19', '1.20', '1.21'],
                    datasets: [{
                            label: "확진",
                            data: [520, 389, 386, 404, 401, 346],
                            borderWidth: "0",
    ...
    try {
        ...
        var data3 = [45832, 38007, 72702, 71747, 66100, 65649]
    ...
    try {
        ...
        var data3 = [1.14, 1.02, 0.53, 0.56, 0.61, 0.53] //  (확진수)/(검사수)*100
