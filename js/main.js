  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['10.26', '10.27', '10.28', '10.29', '10.30', '10.31', '11.1', '11.2', '11.3', '11.4'],
          datasets: [
            {
              label: "신규 확진자",
              data: [88, 103, 125, 114, 127, 124, 97, 75, 118, 125],
