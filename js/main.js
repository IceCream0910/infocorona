...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['3.11', '3.12', '3.13', '3.14', '3.15', '3.16', '3.17', '3.18', '3.19', '3.20'],
          datasets: [
            {
              label: "신규 확진자",
              data: [114, 110, 107, 76, 74, 84, 93, 152, 87, 147],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [91, 444, 2358, 886, 1181, 1642, 1080, 562, 321],
  ...
  try {
    ...
    var data2 = [72, 75, 75, 81, 84, 91, 94]
    var data3 = [714, 834, 1137, 1401, 1540, 1947, 2233]
