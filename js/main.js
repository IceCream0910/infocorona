...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['5.18', '5.19', '5.20', '5.21', '5.22', '5.23', '5.24', '5.25', '5.26', '5.27'],
          datasets: [
            {
              label: "신규 확진자",
              data: [13, 32, 12, 20, 23, 25, 16, 19, 40, 79],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [155, 644, 3146, 1274, 1503, 2014, 1392, 724, 492],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          labels: ['5.22', '5.23', '5.24', '5.25', '5.26', '5.27'],
          datasets: [
            {
              label: "확진",
              data: [23, 25, 16, 19, 40, 79],
  ...
  try {
    ...
    var data3 = [21569, 20333, 19089, 22044, 21061, 22370] //검사중
    var data4 = [11165, 11190, 11206, 11225, 11265, 11344] //누적 확진
