        ...
        var myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [848, 1054, 993, 1036, 1029, 1072, 892],
                }, {
                    label: '해외 유입',
                    backgroundColor: "#a9a9a9",
                    data: [32, 24, 21, 26, 24, 25, 34],
                }],
            },
            options: {
                tooltips: {
        ...
        if (ctx) {
            ...
            var myChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                            label: "확진",
                            data: [1078, 1014, 1062, 1052, 1097, 926],
                            borderWidth: "0",
