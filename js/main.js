...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['9.7', '9.8', '9.9', '9.10', '9.11', '9.12', '9.13', '9.14', '9.15', '9.16'],
          datasets: [
            {
              label: "신규 확진자",
              data: [136, 156, 155, 176, 136, 121, 109, 106, 113, 153],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [539, 1247, 4606, 2757, 3003, 4144, 3531, 1763, 914],
  ...
  try {
    ...
    var data3 = [19620, 16246, 7813, 7732, 13576, 14254] //검사
  ...
  try {
    ...
    var data3 = [0.90, 0.84, 1.54, 1.41, 0.78, 0.79] //  (확진수)/(검사수)*100
