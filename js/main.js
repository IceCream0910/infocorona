...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['6.10', '6.11', '6.12', '6.13', '6.14', '6.15', '6.16', '6.17', '6.18', '6.19'],
          datasets: [
            {
              label: "신규 확진자",
              data: [45, 56, 49, 34, 37, 34, 43, 59, 49, 67],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [177, 690, 3294, 1406, 1618, 2222, 1598, 823, 545],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          labels: ['6.14', '6.15', '6.16', '6.17', '6.18', '6.19'],
          datasets: [
            {
              label: "확진",
              data: [37, 34, 43, 59, 49, 67],
  ...
  try {
    ...
    var data3 = [20793, 22632, 21489, 21714, 21190, 21470] //검사중
    var data4 = [12121, 12155, 12198, 12257, 12306, 12373] //누적 확진
