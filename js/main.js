...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['3.28', '3.29', '3.30', '3.31', '4.1', '4.2', '4.3', '4.4', '4.5', '4.6'],
          datasets: [
            {
              label: "신규 확진자",
              data: [105, 78, 125, 101, 89, 86, 94, 81, 47, 47],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [126, 544, 2819, 1092, 1382, 1909, 1304, 689, 466],
  ...
  try {
    ...
    var data3 = [17885, 18908, 20144, 19571, 19295, 20650] //검사중
    var data4 = [9976, 10062, 10156, 10237, 10284, 10331] //누적 확진
