...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['3.21', '3.22', '3.23', '3.24', '3.25', '3.26', '3.27', '3.28', '3.29', '3.10'],
          datasets: [
            {
              label: "신규 확진자",
              data: [98, 64, 76, 100, 104, 91, 146, 105, 78, 125],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [112, 515, 2656, 1012, 1312, 1851, 1235, 651, 442],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          labels: ['3.25', '3.26', '3.27', '3.28', '3.29', '3.30'],
          datasets: [
            {
              label: "확진",
              data: [104, 91, 146, 105, 78, 125],
  ...
  try {
    ...
    var data3 = [14278, 14369, 16564, 15028, 13531, 16892] //일일 검사
    var data4 = [9241, 9332, 9478, 9583, 9661, 9786] //누적 확진
