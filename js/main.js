...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['8.18', '8.19', '8.20', '8.21', '8.22', '8.23', '8.24', '8.25', '8.26', '8.27'],
          datasets: [
            {
              label: "신규 확진자",
              data: [297, 288, 324, 332, 397, 266, 280, 320, 441, 371],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [406, 1104, 4202, 2401, 2580, 3481, 2773, 1381, 749],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          labels: ['8.22', '8.23', '8.24', '8.25', '8.26', '8.27'],
          datasets: [
            {
              label: "확진",
              data: [397, 266, 280, 320, 441, 371],
  ...
  try {
    ...
    var data3 = [15386, 13236, 21415, 23669, 20073, 18138] //검사
