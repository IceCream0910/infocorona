...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['6.6', '6.7', '6.8', '6.9', '6.10', '6.11', '6.12', '6.13', '6.14', '6.15'],
          datasets: [
            {
              label: "신규 확진자",
              data: [57, 38, 38, 50, 45, 56, 49, 34, 37, 34],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [172, 682, 3259, 1366, 1599, 2182, 1558, 805, 532],
  ...
  try {
    ...
    var data3 = [25494, 24244, 23352, 21356, 20793, 22632] //검사중
    var data4 = [11947, 12003, 12051, 12085, 12121, 12155] //누적 확진
