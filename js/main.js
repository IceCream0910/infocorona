  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['5.24', '5.25', '5.26', '5.27', '5.28', '5.29', '5.30', '5.31', '6.1', '6.2'],
          datasets: [
            {
              label: "신규 확진자",
              data: [16, 19, 40, 79, 58, 39, 27, 35, 38, 49],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [159, 661, 3188, 1305, 1534, 2070, 1436, 738, 499],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          labels: ['5.28', '5.29', '5.30', '5.31', '6.1', '6.2'],
          datasets: [
            {
              label: "확진",
              data: [58, 39, 27, 35, 38, 49],
