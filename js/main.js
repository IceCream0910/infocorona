...
(function($) {
        ...
        var myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [384, 345, 304, 323, 429, 590, 590],
                }, {
                    label: '해외 유입',
                    backgroundColor: "#a9a9a9",
                    data: [19, 17, 22, 21, 28, 31, 31],
                }],
            },
            options: {
                tooltips: {
    ...
    try {
        ...
        if (ctx) {
            ...
            var myChart = new Chart(ctx, {
                ...
                data: {
                    labels: ['2.12', '2.13', '2.14', '2.15', '2.16', '2.17'],
                    datasets: [{
                            label: "확진",
                            data: [362, 326, 344, 457, 621, 621],
                            borderWidth: "0",
    ...
    try {
        ...
        var data3 = [36663, 50892, 43312, 85227, 76651, 71122]
    ...
    try {
        ...
        var data3 = [0.99, 0.64, 0.79, 0.54, 0.81, 0.87] //  (확진수)/(검사수)*100
