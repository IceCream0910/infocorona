...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['7.6', '7.7', '7.8', '7.9', '7.10', '7.11', '7.12', '7.13', '7.14', '7.15'],
          datasets: [
            {
              label: "신규 확진자",
              data: [44, 63, 50, 45, 35, 44, 62, 33, 39, 61],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [228, 755, 3508, 1655, 1791, 2417, 1775, 905, 578],
  ...
  try {
    ...
    var data3 = [22950, 21830, 21845, 24289, 23297, 23404] //검사중
    var data4 = [13373, 13417, 13479, 13512, 13551, 13612] //누적 확진
