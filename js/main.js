...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['5.6', '5.7', '5.8', '5.9', '5.10', '5.11', '5.12', '5.13', '5.14', '5.15'],
          datasets: [
            {
              label: "신규 확진자",
              data: [4, 12, 18, 34, 35, 27, 26, 29, 27, 19],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [147, 619, 3074, 1209, 1454, 1966, 1364, 714, 490],
  ...
  try {
    ...
    var data3 = [10922, 16330, 19579, 20722, 19875, 18843] //검사중
    var data4 = [10909, 10922, 10962, 10991, 11018, 11037] //누적 확진
