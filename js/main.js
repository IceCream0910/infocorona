...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['4.28', '4.29', '4.30', '5.1', '5.2' , '5.3', '5.4', '5.5', '5.6', '5.7'],
          datasets: [
            {
              label: "신규 확진자",
              data: [9, 4, 9, 6, 13, 8, 3, 2, 4, 12],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [141, 592, 2967, 1174, 1438, 1957, 1355, 710, 488],
  ...
  try {
    ...
    var data3 = [8588, 8176, 8858, 8009, 8429, 8867] //검사중
    var data4 = [10793, 10801, 10804, 10806, 10810, 10822] //누적 확진
