...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['9.27', '9.28', '9.29', '9.30', '10.1', '10.2', '10.3', '10.4', '10.5', '10.6'],
          datasets: [
            {
              label: "신규 확진자",
              data: [50, 38, 113, 77, 63, 75, 64, 73, 75, 114],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [594, 1334, 4836, 2979, 3242, 4515, 3890, 1964, 999],
  ...
  try {
    ...
    var data3 = [5342, 6082, 6486, 6033, 13055, 12640] //검사
  ...
  try {
    ...
    var data3 = [1.18, 1.23, 0.99, 1.21, 0.57, 0.90] //  (확진수)/(검사수)*100
