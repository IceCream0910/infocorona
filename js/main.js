...
(function ($) {
  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['9.23', '9.24', '9.25', '9.26', '9.27', '9.28', '9.29', '9.30', '10.1', '10.2'],
          datasets: [
            {
              label: "신규 확진자",
              data: [125, 114, 61, 95, 50, 38, 113, 77, 63, 75],
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "확진자 수",
              data: [587, 1316, 4775, 2927, 3198, 4445, 3808, 1917, 979],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          labels: ['9.27', '9.28', '9.29', '9.30', '10.1', '10.2'],
          datasets: [
            {
              label: "확진",
              data: [50, 38, 113, 77, 63, 75],
  ...
  try {
    ...
    var data3 = [6172, 4786, 11741, 9955, 5436, 5342] //검사
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ["9.26", "9.27", "9.28", "9.29", "9.30", "10.1"],
          datasets: [
            {
              label: "일 검사자수",
              data: data3,
  ...
  try {
    ...
    var data3 = [1.54, 1.04, 0.32, 1.14, 1.42, 1.18] //  (확진수)/(검사수)*100
