...
(function($) {
        ...
        var myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [1030, 1025, 940, 1004, 788, 641, 985],
                }, {
                    label: '해외 유입',
    ...
    try {
        ...
        if (ctx) {
            ...
            var myChart = new Chart(ctx, {
                ...
                data: {
                    labels: ['12.29', '12.30', '12.31', '1.1', '1.2', '1.3'],
                    datasets: [{
                            label: "확진",
                            data: [1050, 967, 1029, 824, 657, 1020],
                            borderWidth: "0",
    ...
    try {
        ...
        var data3 = [102497, 95082, 101176, 53540, 74272, 59379] //검사
    ...
    try {
        ...
        var data3 = [1.02, 1.02, 1.02, 1.03, 0.89, 1.72] //  (확진수)/(검사수)*100
