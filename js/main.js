  ...
  "use strict";
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['10.9', '10.10', '10.11', '10.12', '10.13', '10.14', '10.15', '10.16', '10.17', '10.18'],
          datasets: [
            {
              label: "신규 확진자",
              data: [72, 58, 97, 102, 84, 110, 47, 73, 91, 76],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          labels: ['10.13', '10.14', '10.15', '10.16', '10.17', '10.18'],
          datasets: [
            {
              label: "확진",
              data: [84, 110, 47, 73, 91, 76],
